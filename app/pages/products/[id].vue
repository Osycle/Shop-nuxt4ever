...
<template>
  <div class="product-detail default">
      ...
      <div class="container flex justify-between gap-y-6 flex-wrap">
            ...
            <div class="swiper mySwiper2 rounded-2xl overflow-hidden">
              <swiper-container 
                  ...
                  <swiper-slide
                    ...
                    :key="key"
                  >
                  <img :src="image" alt="img" class="w-full aspect-[3/4] object-cover" />
                </swiper-slide>
              </swiper-container>
            </div>
            <div class="swiper mySwiper">
              <div class="swiper-wrapper">
                <div class="swiper-slide" 
                  v-for="(image, key) in product.images" :key="key"
                  @click="swiper.to(key)"
                >
                  <img :src="image" alt="img" class="w-full aspect-[3/4] object-cover" />
                </div>
        ...
        <div class="product-item product-infor md:w-1/2 w-full lg:pl-[15px] md:pl-2">
          <div class="flex justify-between">
            <div>
              <div class="product-category caption2 text-secondary font-semibold uppercase">{{product.category}}</div>
    ...
    <div v-if="false" class="desc-tab md:pb-20 pb-10">
      <div class="container">
    ...
    <div v-if="false" class="review-block md:py-20 py-10 bg-surface">
      <div class="container">
          ...
          <div class="list-img lg:w-3/4 md:w-[70%] lg:pl-[15px] md:pl-[15px]">
            ...
            <div class="list md:mt-6 mt-3">
              <div class="swiper swiper-img-review h-full relative">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="./assets/images/product/1000x1000.png" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                  </div>
                  <div class="swiper-slide">
                    <img src="./assets/images/product/1000x1000.png" alt="img" class="w-[120px] aspect-square object-cover rounded-lg" />
                  </div>
          ...
          <div class="item flex max-lg:flex-col gap-y-4 w-full py-6 border-t border-line">
            <div class="left lg:w-1/4 w-full lg:pr-[15px]">
              <div class="list-img-review flex gap-2">
                <img src="./assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg" />
                <img src="./assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg" />
                <img src="./assets/images/product/1000x1000.png" alt="img" class="w-[60px] aspect-square rounded-lg" />
              </div>
              <div class="user mt-3">
