    ...
    <div class="about-us-block">
      <div class="container">
        ...
        <div class="list-img grid sm:grid-cols-3 gap-[30px] md:pt-20 pt-10">
          <div class="bg-img">
            <img src="/images/other/about-us1.png" alt="bg-img" class="w-full rounded-[30px]" />
          </div>
          <div class="bg-img">
            <img src="/images/other/about-us2.png" alt="bg-img" class="w-full rounded-[30px]" />
          </div>
          <div class="bg-img">
            <img src="/images/other/about-us3.png" alt="bg-img" class="w-full rounded-[30px]" />
          </div>
        </div>
      </div>
    </div>
